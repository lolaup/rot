<?php 
   ...
   $t_id=$_COOKIE['tea_id'];
   $re="select wenjuan.w_id,course.c_id,course.c_name,w_title,day_creat,day_finish from course,wenjuan where course.t_id='$t_id' and course.t_id=wenjuan.t_id";
...
<body>
    <div id="left-nav">
        ...
        <ul id="list">
            ...
            <li class="this"><a href="tea_rot.php"><span class="glyphicon glyphicon-edit"> 制定问卷</span></a></li>
