<?php
    ...
    $re="select x_id,xiaoxi.x_title,xiaoxi.x_date,x_id from man_psw,xiaoxi where xiaoxi.x_type='student' or xiaoxi.x_type='all'";
...
<body>
    <div id="left-nav">
        ...
        <hr>
        <ul id="list">
            <li class="active this"><a href=""><span class="glyphicon glyphicon-home"> 系统通知</span></a></li>
