<?php
   ...
   $w_id=$_GET['w_id'];
   $re="select q_id,q_title,s_A,A_score,s_B,B_score,s_C,C_score,s_D,D_score from man_wenti where w_id='$w_id'";
         ...
         <ul id="list-que">
             <?php
                while($value=mysql_fetch_array($query))
                {
                    ...
                    echo'(';
                    echo"{$value['D_score']}";
                    echo'分)</label><button class="btn btn-danger pull-right delete dan-btn"><a href="../php/man_wenti_del.php?q_id=';
                    echo"{$value['q_id']}";
                    echo'&w_id=';
                    echo $w_id;
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="../php/man_wenti_add.php?w_id=<?php echo $w_id;?>" method="post">
