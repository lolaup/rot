...
<body>
    <div id="left-nav">
        ...
        <ul id="list">
            ...
            <li class="this"><a href="tea_psw.php"><span class="glyphicon glyphicon-cog"> 修改密码</span></a></li>
    ...
    <div id="right-content"> 
            ...
            <div id="psw" class="pag pag5">
                ...
                <form>
                    ...
                    <button type="submit" class="btn btn-success"data-toggle="modal" data-target="#exit">确认</button>
                  </form>
                  <!-- 确认修改密码模态框 -->
